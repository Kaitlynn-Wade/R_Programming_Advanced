...
#replaces the for loop; a little faster
...
lapply(l1, quantile, probs=c(0.025, 0.975)) #applies things and returns a list
sapply(l1, quantile, probs=c(0.025, 0.975)) #simplify results 
